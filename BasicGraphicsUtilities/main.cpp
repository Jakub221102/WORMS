...
int main() {
	...
	std::vector<std::pair<float, float>> vertices3{
		{400.0f, -100.0f * sqrt(3) + 900.0f},
		{500.0f, -100.0f * sqrt(3) + 900.0f},
		{550.0f, -150.0f * sqrt(3) + 900.0f},
		{650.0f, -150.0f * sqrt(3) + 900.0f},
		{700.0f, -200.0f * sqrt(3) + 900.0f},
		{800.0f, -200.0f * sqrt(3) + 900.0f},
		{850.0f, -150.0f * sqrt(3) + 900.0f},
		{850.0f, 900.0f},
		//{500.0f, -200.0f},
		//{400.0f, -200.0f},
		/*{650.0f, -50.0f * sqrt(3) + 900.0f},
		{550.0f, -50.0f * sqrt(3) + 900.0f},*/
		//{500.0f, 500.0f},
		{400.0f, 900.0f},
	...
	GR::StaticPhysicalObject mTerrain(world, deltaTime, vertices3, "dsaw");
	...
	obj.setKeyArguments(sf::Keyboard::Right, {50.0f, 0.0f }, InputType::REALTIME); // pass velocity to move method
	obj.addKeyBinding(sf::Keyboard::Left, &Worm::move_left, InputType::REALTIME);
	obj.setKeyArguments(sf::Keyboard::Left, {-50.0f, 0.0f }, InputType::REALTIME); // pass velocity to move method
